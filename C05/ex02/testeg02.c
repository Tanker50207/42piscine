...
/*   Updated: 2023/09/20 16:40:04 by eguefif          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(void)
{
	...
	if ((retval = ft_iterative_power(-3, 0)) == 1)
		...
		printf("\e[0;31mTest Failed -3^0: %d should be 1 \n", retval);
	if ((retval = ft_iterative_power(13, 1)) == 13)
		printf("\e[0;32mTest Passed\n");
	else
		printf("\e[0;31mTest Failed 3^0: %d should be 1 \n", retval);
	if ((retval = ft_iterative_power(0, 3)) == 0)
		printf("\e[0;32mTest Passed\n");
	else
